...
- :ballot_box_with_check:[Juicer](https://github.com/theaidenlab/juicebox/wiki/Download) - Java full pipeline to convert raw reads into Hi-C maps, visualized in Juicebox. Calls domains, loops, CTCF binding sites. `.hic` file format for storing multi-resolution Hi-C data. <details>
    <summary>Paper</summary>
